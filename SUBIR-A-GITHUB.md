...
1. En PowerShell, dentro de esta carpeta, ejecuta `powershell -ExecutionPolicy Bypass -File .\PREPARAR-GITHUB.ps1`. Se creará `MDS-Ventas-Native-v15-GitHub.zip` en la carpeta padre.
...
La versión 2.3.4 incorpora el selector fiable de empresa en el pedido rápido
del widget y reserva de forma nativa las barras del sistema y el teclado,
