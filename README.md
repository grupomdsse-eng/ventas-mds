...
La APK incluye cuatro widgets para la pantalla de inicio: **Flujos próximos** es un tablón 3×2 con las tareas de hoy y mañana y el color de su etapa; al añadirlo permite elegir el tablón y las columnas. **Chat directo** es un acceso circular con la foto del compañero elegido; **Hacer pedido** es un botón 1×1 para abrir el formulario nativo; y **Pedidos pendientes** muestra visualmente los pedidos aún por tramitar. El pedido rápido sincroniza la sesión de la aplicación antes de cargar datos, obliga a seleccionar primero la empresa y después muestra únicamente sus clientes; también admite foto, documento o audio. Los comerciales no pueden elegir preparador desde este formulario. Si la sesión ha caducado, muestra el aviso y permite reintentar en lugar de bloquear el selector. Para que puedan consultar datos, inicia sesión una vez en la APK y marca “Mantener mi sesión iniciada”. Los tablones se actualizan aproximadamente cada 30 minutos, al abrir la aplicación y con su botón de actualización. El de pedidos se refresca también al llegar el aviso de un pedido nuevo si Firebase está configurado.
