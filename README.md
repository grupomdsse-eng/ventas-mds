...
La APK incluye cuatro widgets para la pantalla de inicio: **Flujos próximos** es un tablón 3×2 con las tareas de hoy y mañana y el color de su etapa; al añadirlo permite elegir el tablón y las columnas. **Chat directo** es un acceso circular con la foto del compañero elegido; **Hacer pedido** es un botón 1×1 que abre directamente el formulario completo de pedido dentro de MDS Ventas; y **Pedidos pendientes** muestra visualmente los pedidos aún por tramitar. El widget de pedido no carga empresas ni clientes por su cuenta: usa el mismo formulario de la aplicación, con los permisos y datos de sesión actuales. Los tablones se actualizan aproximadamente cada 30 minutos, al abrir la aplicación y con su botón de actualización. El de pedidos se refresca también al llegar el aviso de un pedido nuevo si Firebase está configurado.
